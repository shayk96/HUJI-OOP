...
public class BrickerGameManager extends GameManager {
    ...
    private static final int HIGHEST_ROW = 50;
    ...
    /**
     * the constructor for the class' creates the window with the size given and the name given
     *
    ...
    public void initializeGame(ImageReader imageReader, SoundReader soundReader,
        ...
        strategyFactory = new BrickStrategyFactory(gameObjects(), this, imageReader, soundReader,
    ...
    private void createNumericLifeCounter() {
        Vector2 numericCounterPosition = new Vector2(BORDER_WIDTH, 12.5f);
    ...
    /**
     * creates the graphic life counter for the game
     *
    ...
    private void createGraphicLifeCounter(ImageReader imageReader) {
        ...
        Vector2 firstHeartLocation = new Vector2(BORDER_WIDTH + 25, 15);
    ...
    public void update(float deltaTime) {
        ...
        for (GameObject object : gameObjects()) {
            if (object instanceof Puck && object.getCenter().y() > windowDimensions.y()) {
    ...
    private void createBricks(ImageReader imageReader, Vector2 windowDimension) {
        ...
        for (int row = 0; row < NUM_OF_ROWS; row++) {
            for (int col = 0; col < NUM_OF_BRICKS_IN_ROW; col++) {
                ...
                Vector2 brickLocation = new Vector2(5 + BORDER_WIDTH + (col * brickWidth),
