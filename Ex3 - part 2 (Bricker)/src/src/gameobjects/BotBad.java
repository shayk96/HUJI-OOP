...
/**
 * the class responsible for the bad bot
 */
public class BotBad extends GameObject {
     ...
     * @param renderable          The renewable representing the object.
     ...
     */
    public BotBad(Vector2 topLeftCorner, Vector2 dimensions, Renderable renderable, Vector2 windowDimensions,
